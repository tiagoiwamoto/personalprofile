...
import br.com.tiagoiwamoto.core.mapper.SkillMapper;
...
public class SkillUsecase {
    ...
    private final String DOMINIO = "skill";

    public List<SkillDTO> listarRegistros(){
    ...
    public SkillDTO gravarRegistro(SkillDTO dados){
    ...
    public SkillDTO atualizarRegistro(SkillDTO dados){
