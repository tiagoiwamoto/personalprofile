...
import br.com.tiagoiwamoto.adapter.out.SoftwareAdapter;
import br.com.tiagoiwamoto.core.mapper.SoftwareMapper;
...
@ApplicationScoped
@Slf4j
public class SoftwareUsecase {

    @Inject
    private SoftwareAdapter adapter;
    @Inject
    private SoftwareMapper mapper;
    private final String DOMINIO = "software";

    public List<SoftwareDTO> listarRegistros(){
    ...
    public SoftwareDTO gravarRegistro(SoftwareDTO dados){
    ...
    public SoftwareDTO atualizarRegistro(SoftwareDTO dados){
