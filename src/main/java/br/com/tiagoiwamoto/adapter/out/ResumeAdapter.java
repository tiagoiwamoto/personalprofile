...
@ApplicationScoped
@Slf4j
public class ResumeAdapter implements ResumePort, Serializable {

    @Inject
    private ResumeRepository repository;
    private final String ADAPTER_NAME = "resume";

    private static final long serialVersionUID = -5739579722211298534L;

    @Override
    public List<ResumeEntity> all() {
    ...
    @Override
    public ResumeEntity recoveryByUuid(UUID uuid) {
    ...
    @Override
    @Transactional
    public ResumeEntity save(ResumeEntity data) {
    ...
    @Override
    @Transactional
    public void delete(ResumeEntity data) {
